            ...
            <div class="card-body">
              <div class="text-center mb-5">
                <div class="row">
                  ...
                  <div class="col-md-6"><img src="<?= base_url('assets/uploads/image/logo/') . $setting_aplikasi->kode; ?>" height="48" class='mb-4'></div>
                </div>    
              ...
              <?php echo form_close(); ?>
              <div class="row"><a href="<?= base_url('auth/register_user'); ?>">Register</a></div>
